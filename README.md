...
2. **Setup:**
   ...
   - Compile the source code using the rpgax.sh script in your Terminal.
...
## Controls
- The whole entire game is played by just using just the keyboard. No mouse.
- Then just follow the on-screen prompts for in-game choices.
